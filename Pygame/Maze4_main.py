...
PATH= [(1, 1), (2, 1), (3, 1), (4, 1), (4, 2), (5, 2), (6, 2), (6, 1), (7, 1), (8, 1), (8, 2), (9, 2), (10, 2), (10, 1), (11, 1), (12, 1), (13, 1), (13, 2), (14, 2), (15, 2), (15, 1), (15, 1), (15, 2), (14, 2), (13, 2), (13, 1), (12, 1), (11, 1), (10, 1), (10, 2), (9, 2), (8, 2), (8, 3), (7, 3), (7, 4), (7, 5), (8, 5), (8, 6), (8, 7), (8, 8), (7, 8), (6, 8), (11, 16), (12, 16), (13, 16), (13, 15), (14, 15), (15, 15), (15, 14), (15, 13), (15, 12), (15, 11), (15, 10), (15, 9), (15, 8), (15, 7), (15, 6), (14, 6), (13, 6), (13, 6), (14, 6), (15, 6), (15, 7), (15, 8), (15, 9), (15, 10), (15, 11), (15, 10), (15, 9), (15, 8), (14, 8), (13, 8), (12, 8), (11, 8), (11, 7), (10, 7), (9, 7), (8, 7), (8, 6), (8, 5), (7, 5), (6, 5), (5, 5), (4, 5), (4, 6), (4, 7), (4, 7), (3, 7), (2, 7), (1, 7), (1, 8), (1, 9), (1, 10), (1, 11), (1, 12), (2, 12), (2, 13), (2, 14), (1, 14), (1, 15), (1, 16), (2, 16), (3, 16), (3, 15), (4, 15), (5, 15), (5, 16)]
output=[]
for elem in PATH:
    tempx=elem[0]*53
    tempy=elem[1]*53
...
def loadMaze2(input_file4):
    #load the data from the file into a 2D list
    with open(input_file4) as i:
        maze2 = []
        for line in i:
            line = line.split()
            maze2.append(line)
...
def loadMaze1(input_file4):
    maze3=[]
    l=len(input_file4)
    ln=len(input_file4[0])
    for i in range(0,l):
        for j in range(0,ln):
            if input_file4[i][j]== "1" :
                maze3.append(input_file4[i][j])
            elif input_file4[i][j]== "0" :
                maze3.append(input_file4[i][j])
            elif input_file4[i][j]== "s" :
                maze3.append(input_file4[i][j])
            elif input_file4[i][j]== "e" :
                maze3.append(input_file4[i][j])
            elif input_file4[i][j]== "a" :
                maze3.append(input_file4[i][j])
            elif input_file4[i][j]== "b" :
                maze3.append(input_file4[i][j])
            elif input_file4[i][j]== "c" :
                maze3.append(input_file4[i][j])
            elif input_file4[i][j]== "d" :
                maze3.append(input_file4[i][j])
            elif input_file4[i][j]== "f" :
                maze3.append(input_file4[i][j])
            elif input_file4[i][j]== "g" :
                maze3.append(input_file4[i][j])
            elif input_file4[i][j]== "h" :
                maze3.append(input_file4[i][j])
            elif input_file4[i][j]== "i" :
                maze3.append(input_file4[i][j])
            elif input_file4[i][j]== "2" :
                maze3.append(input_file4[i][j])
            elif input_file4[i][j]== "3" :
                maze3.append(input_file4[i][j])
            elif input_file4[i][j]== "4" :
                maze3.append(input_file4[i][j])
            else:
                continue
...
def main():
    ...
    global maze2
    global screen
    maze2=loadMaze2(constants3.input_file4)
